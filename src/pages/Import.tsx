...
import { parseCustomers, parseItems, parseSalesOrders } from "../lib/importParsers";
...
type ImportType = "customers" | "items" | "orders";
...
const TEMPLATES: Record<ImportType, { headers: string[]; sample: string[] }> = {
  ...
  items: {
    headers: ["Item Number", "Description", "U/M", "Rate"],
    sample: ["RP-100", "1/2in Twisted Rope, 600ft coil", "EA", "42.50"],
  },
  orders: {
    headers: [
      "PO Number",
...
export default function Import() {
  ...
  const rows = type === "customers" ? customerRows : type === "items" ? itemRows : orderRows;
